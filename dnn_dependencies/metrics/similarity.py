...
def _sortDict(d: defaultdict | dict[Any, Any]) -> dict[Any, Any]:
    ...
    :return: The function `_sortDict` returns a sorted dictionary.
    """
...
def computeDegreeDistribution(graph: DiGraph, inDegree: bool = True) -> dict[int, int]:
    ...
    :return: a dictionary that represents the degree distribution of nodes in the graph. The keys of the
...
def computeClusteringCoefficientDistribution(graph: DiGraph) -> dict[int, int]:
    ...
    :type graph: DiGraph
    :return: a dictionary that represents the clustering coefficient distribution of nodes in the given
...
def computeNodeTypeDistribution(graph: DiGraph) -> dict[str, int]:
    ...
    that node
    :type graph: DiGraph
    :return: a dictionary that represents the distribution of node operation types in the given graph.
